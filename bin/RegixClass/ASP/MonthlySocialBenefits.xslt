<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  xmlns:msxsl="urn:schemas-microsoft-com:xslt" exclude-result-prefixes="msxsl"
                 xmlns:dw1="http://egov.bg/RegiX/ASP/MonthlyBenefits/GetMonthlySocialBenefitsResponse"
  ...
  <xsl:template match="/">
    <div id="pn2">
      <h1>
        Справка за отпуснати помощи по чл. 9 от ППЗСП
      </h1>
      <xsl:apply-templates/>
    </div>
  </xsl:template>
  <xsl:template match="dw1:GetMonthlySocialBenefitsResponse">
    <xsl:apply-templates/>
  </xsl:template>
